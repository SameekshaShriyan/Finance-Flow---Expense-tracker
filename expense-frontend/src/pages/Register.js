    ...
    <div style={{
      ...
      <div style={{ width:"100%", maxWidth:420, padding:24, animation:"fadeUp 0.5s ease", position:"relative", zIndex:1 }}>
        <div style={{ textAlign:"center", marginBottom:36 }}>
          ...
          <h1 style={{ fontSize:28, fontWeight:800, color:"var(--text)", letterSpacing:"-0.03em" }}>Create account</h1>
          <p style={{ color:"var(--text2)", marginTop:6, fontSize:14 }}>Start tracking your finances</p>
        </div>
        ...
        <p style={{ textAlign:"center", marginTop:20, color:"var(--text3)", fontSize:13 }}>
          ...
          <Link to="/" style={{ color:"var(--accent2)", fontWeight:600 }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
